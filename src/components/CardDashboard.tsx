...
export function CardDashboard() {
  ...
  return (
    <div className="w-full lg:h-[112px] grid grid-cols-2 lg:grid-cols-4 gap-8 mb-8 md:border-0 md:pb-0 pb-6 border-b border-b-secondary-300">
      <div className="h-[64px] lg:h-full col col-span-2 shadow-base-lg flex  rounded-lg overflow-hidden">
        <div className="w-[50%] flex gap-4 justify-start lg:justify-center items-center">
          <div className="md:w-16 md:h-16 h-8 w-8 bg-primary-100 rounded-full flex items-center justify-center">
            <Image
              src={lawImage}
              alt=""
              className="md:h-[40px] md:w-[40px] h-[20px] w-[20px]"
            />
          </div>
          <div>
            <h4 className="text-sm md:text-2xl font-normal">
              Balance{' '}
              <span className="md:text-2xl text-xs md:text-text-base text-secondary-500 block">
                in US$
              </span>
            </h4>
            <span className="text-base text-secondary-500 md:block hidden">
              (approximately)
            </span>
          </div>
        </div>
      ...
      <div className="md:h-[112px] lg:h-full shadow-base-lg rounded-lg overflow-hidden flex md:flex-row flex-col">
        ...
        <div
          data-suspense={dailyVariationCrypto === null}
          className="h-[60%] md:h-full md:flex-1 data-[suspense=true]:bg-secondary-500 data-[suspense=true]:animate-pulse"
        >
      ...
      <div className="md:h-[112px] lg:h-full shadow-base-lg rounded-lg overflow-hidden flex md:flex-row flex-col">
        <div className="w-full h-full md:h-full md:w-[50%] flex flex-col items-start justify-center md:justify-start md:p-4">
          ...
          <span className="text-xs text-secondary-500 mb-4  md:pr-0 px-4">
        ...
        <div className="w-full h-[60%] md:w-[50%]">
          <Image
            src={elephantImage}
            alt=""
